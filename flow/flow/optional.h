...
public:
    ...
    optional(T&& value) : _engaged(true), _storage(std::move(value)) { }
    ...
    optional<T>& operator=(U&& value) {
        _storage._value = std::forward<U>(value);
        _engaged = true;
        return *this;
    }
...
private:
    bool _engaged;                              // true when there is actually a value
